...
public sealed class GetTimeOffByEmailQueryResponse
{
    ...
    public static implicit operator GetTimeOffByEmailQueryResponse(TimeOffInformation timeOffInformation)
    {
        if (timeOffInformation is null) return new GetTimeOffByEmailQueryResponse();
